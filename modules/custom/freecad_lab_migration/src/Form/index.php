...
//return $msg;
          ...
          // form pending review entire lab
           elseif (($form_state->getValue(['lab_actions']) == 2) && ($form_state->getValue(['lab_experiment_actions']) == 0) && ($form_state->getValue(['lab_experiment_solution_actions']) == 0)) {
            ...
            // Email notification to the solution provider when entire lab is marked as pending for review
...
Your all the uploaded solutions for the Lab with Title: @lab_title have been marked as pending to be reviewed.
...
//   '[@site_name] Your uploaded Lab Migration solutions have been disapproved',
//   [
...
// /* Email subject */
// $email_subject = $this->t(
//   '[@site_name] Your uploaded Lab Migration solutions including the Lab proposal have been deleted',
//   [
//     '@site_name' => $config->get('site_name'),
//   ]
// );
...
// /* Email subject */
// $email_subject = $this->t(
//   '[@site_name] Your uploaded Lab Migration solution has been approved',
//   [
//     '@site_name' => $config->get('site_name'),
//   ]
// );
...
// /* Email subject */
// $email_subject = $this->t(
//   '[@site_name] Your uploaded Lab Migration solution has been marked as pending',
//   [
//     '@site_name' => $config->get('site_name'),
//   ]
// );
...
// /* Email subject */
// $email_subject = $this->t(
//   '[@site_name] Your uploaded Lab Migration solution has been disapproved',
//   [
//     '@site_name' => $config->get('site_name'),
//   ]
// );
...
// We regret to inform you that your experiment with the following details under R Lab Migration has been disapproved and deleted.
...
//             return;
//           }
// /** Sending email when everything is done **/
...
//       $this->t('Error sending email message.')
//     );
//   }
// }
...
// else {
//   \Drupal::messenger()->addError(
//     $this->t('You do not have permission to bulk manage code.')
//   );
// }   
//  return $msg;
//   }
...
// $form['download_lab_wrapper']['download_experiment_wrapper']['download_solution'] = [
//   '#type' => 'item',
//   '#markup' => '<div id="ajax_download_experiment_solution"></div>',
// ];
...
//     //var_dump($solution_rows);die;
//       $form['download_lab_wrapper']['download_experiment_wrapper']['download_solution_wrapper']['solution_files'] = [
//         '#type' => 'fieldset',
//         '#title' => t('List of solution files'),
//       ];
//       $solution_files_header = ['Filename', 'Type']; // Table headers
...
//     ];
          // Add the table to the fieldset
//$form['download_lab_wrapper']['download_experiment_wrapper']['download_solution_wrapper']['solution_files']['table'] = $table;
